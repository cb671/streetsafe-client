...
export default function Home() {
  ...
  }, [setClickHandler, clearClickHandler]);
    ...
    <>
      ...
      {crimeData ? (
        ...
        >
          <button
            type="button"
            className="absolute right-3 top-3 inline-flex h-8 w-8 items-center justify-center rounded-full text-white transform transition duration-500 hover:scale-125"
